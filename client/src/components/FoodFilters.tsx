...
export const FoodFilters: React.FC<FoodFiltersProps> = ({ onFilterChange }) => {
  ...
  return (
    <div className="bg-black border border-zinc-800 rounded-lg shadow-md p-4 mb-6">
      {/* Search Bar */}
      ...
      {showFilters && (
        <div className="border-t border-zinc-800 pt-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-zinc-900 border border-zinc-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500"
              >
                {categories.map(cat => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Max Prep Time (min)</label>
              <Input
                type="number"
                placeholder="60"
